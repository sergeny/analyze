...
def prepare_credentials(flags):
  ...
  if credentials is None or credentials.invalid:
    credentials = run_flow(FLOW, storage, flags) #run Auth Flow and store credentials

  return credentials



def initialize_service(flags):
  ...
  credentials = prepare_credentials(flags)
